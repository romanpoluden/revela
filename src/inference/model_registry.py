...
REGISTRY: dict[str, dict] = {
    ...
    "dermoscopic_cancer_risk_bcn_mnh_v1": {
        ...
        "safety_note": (
            "Educational cancer-risk review only. "
            "Model confidence is not clinical certainty. "
            "Not diagnosis and not treatment guidance."
        ),
        "model_limitations": (
            "Trained on dermoscopic images from BCN20000 and MNH datasets. "
            "Performance may vary on out-of-distribution images. "
            "Educational prototype."
        ),
        "recommended_next_step": (
            "Review findings with a qualified dermatologist. "
            "Do not act on model output alone."
        ),
    },
